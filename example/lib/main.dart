            ...
            children: [
              ...
              IconButton(
                icon: Icon(
                  ...
                  color: controller.freeStyleMode == FreeStyleMode.erase ? Theme.of(context).scaffoldBackgroundColor : null,
                ),
              ...
              IconButton(
                icon: Icon(
                  ...
                  color: controller.freeStyleMode == FreeStyleMode.draw ? Theme.of(context).scaffoldBackgroundColor : null,
                ),
              ...
              IconButton(
                icon: Icon(
                  PhosphorIcons.textT,
                  color: textFocusNode.hasFocus ? Theme.of(context).scaffoldBackgroundColor : null,
                ),
                onPressed: addText,
              ),
              // Add sticker image
                ...
                PopupMenuButton<ShapeFactory?>(
                  ...
                  child: Padding(
                    ...
                    child: Icon(
                      ...
                      color: controller.shapeFactory != null ? Theme.of(context).scaffoldBackgroundColor : null,
                    ),
                  ),
                )
              else
