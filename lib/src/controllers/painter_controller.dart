...
class PainterController extends ValueNotifier<PainterControllerValue> {
  ...
  }) : this.fromValue(PainterControllerValue(settings: settings, drawables: drawables ?? const [], background: background));
...
class PainterControllerValue {
  ...
  @override
  @override
  int get hashCode => Object.hash(Object.hashAll(_drawables), background, settings, selectedObjectDrawable);
}
...
class _NoObjectPassedBackgroundDrawable extends ObjectDrawable {
  ...
  ObjectDrawable copyWith(
      {bool? hidden, Set<ObjectDrawableAssist>? assists, ui.Offset? position, double? rotation, double? scale, bool? locked}) {
    throw UnimplementedError(
