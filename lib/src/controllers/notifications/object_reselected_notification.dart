...
class ObjectDrawableReselectedNotification extends DrawableNotification<ObjectDrawable?>{

  /// Creates a [ObjectDrawableReselectedNotification] with the given [drawable].
  ObjectDrawableReselectedNotification(ObjectDrawable? drawable) : super(drawable);
}