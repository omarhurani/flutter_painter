...
class _ObjectWidgetState extends State<_ObjectWidget> {
  ...
  List<ObjectDrawable> get drawables => PainterController.of(context).value.drawables.whereType<ObjectDrawable>().toList();
                                          ...
                                          Positioned(
                                            ...
                                            child: MouseRegion(
                                              ...
                                              child: GestureDetector(
                                                ...
                                                onPanUpdate: (details) =>
                                                    onResizeControlPanUpdate(entry, details, constraints, Axis.vertical, true),
                                          ...
                                          Positioned(
                                            ...
                                            child: MouseRegion(
                                              ...
                                              child: GestureDetector(
                                                ...
                                                onPanUpdate: (details) =>
                                                    onResizeControlPanUpdate(entry, details, constraints, Axis.vertical, false),
                                          ...
                                          Positioned(
                                            ...
                                            child: MouseRegion(
                                              ...
                                              child: GestureDetector(
                                                ...
                                                onPanUpdate: (details) =>
                                                    onResizeControlPanUpdate(entry, details, constraints, Axis.horizontal, true),
                                          ...
                                          Positioned(
                                            ...
                                            child: MouseRegion(
                                              ...
                                              child: GestureDetector(
                                                ...
                                                onPanUpdate: (details) =>
                                                    onResizeControlPanUpdate(entry, details, constraints, Axis.horizontal, false),
  ...
  void onScaleControlPanUpdate(MapEntry<int, ObjectDrawable> entry, DragUpdateDetails details, BoxConstraints constraints,
...
class _ObjectControlBox extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final activeColor = this.activeColor ?? theme?.scaffoldBackgroundColor ?? Colors.blue;
